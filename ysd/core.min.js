...
!function (b, c, a) {
  ...
  !function (b) {
    ...
    var d = b(73),
        e = b(23)("iterator"),
        f = b(136);c.exports = b(7).getIteratorMethod = function (b) {
    ...
    function Dict(b) {
      var c = u(null);return b != a && (t(b) ? s(b, !0, function (a, b) {
        c[a] = b;
      }) : n(c, b)), c;
      ...
      r(j);var a,
          ...
          e = i(b),
          k = e.length,
          f = 0;if (3 > arguments.length) {
        if (!k) throw TypeError("Reduce of empty object with no initial value");a = b[e[f++]];
      } else a = Object(l);for (; k > f;) {
      ...
      return w(a) && o(a) === Dict.prototype;
        ...
        c = function c(b) {
      var e = 1 == b,
          c = 4 == b;return function (l, m, n) {
        var f,
            i,
            g,
            o = v(m, n, 3),
            k = h(l),
            j = e || 7 == b || 2 == b ? new ("function" == typeof this ? this : Dict)() : a;for (f in k) {
          if (d(k, f) && (i = k[f], g = o(i, f, l), b)) if (e) j[f] = g;else if (g) switch (b) {case 2:
              j[f] = i;break;case 3:
              return !0;case 5:
              return i;case 6:
              return f;case 7:
              j[g[0]] = g[1];} else if (c) return !1;
        }return 3 == b || c ? c : j;
      };
    },
        j = c(6),
      ...
      var c,
          ...
          g = b._a,
          h = b._k;do {
        if (b._i >= g.length) return b._t = a, f(1);
      } while (!d(e, c = g[b._i++]));return "keys" == h ? f(0, c) : "values" == h ? f(0, e[c]) : f(0, [c, e[c]]);
    }), Dict.prototype = null, e(e.G + e.F, { Dict: Dict }), e(e.S, "Dict", { keys: g("keys"), values: g("values"), entries: g("entries"), forEach: c(0), map: c(1), filter: c(2), some: c(3), every: c(4), find: c(5), findKey: j, mapPairs: c(7), reduce: reduce, keyOf: l, includes: includes, has: d, get: get, set: set, isDict: isDict });
  }, function (b, e, a) {
    var c = a(10),
        d = a(157);b.exports = a(7).getIterator = function (a) {
      var b = d(a);if ("function" != typeof b) throw TypeError(a + " is not iterable!");return c(b.call(a));
    };
  }, function (f, g, a) {
    var c = a(2),
        d = a(7),
        b = a(6),
        e = a(290);b(b.G + b.F, { delay: function delay(a) {
    ...
    var c = a(291),
        b = a(6);a(7)._ = c._ = c._ || {}, b(b.P + b.F, "Function", { part: a(290) });
  }, function (c, d, b) {
    var a = b(6);a(a.S + a.F, "Object", { isObject: b(11) });
  }, function (c, d, b) {
    var a = b(6);a(a.S + a.F, "Object", { classof: b(73) });
  }, function (d, e, b) {
    var a = b(6),
        c = b(299);a(a.S + a.F, "Object", { define: c });
  }, function (b, g, a) {
    var c = a(9),
        d = a(49),
        e = a(221),
        f = a(30);b.exports = function define(a, b) {
      for (var g, h = e(f(b)), j = h.length, i = 0; j > i;) {
        c.f(a, g = h[i++], d.f(b, g));
      }return a;
    };
  }, function (e, f, a) {
    var b = a(6),
        c = a(299),
        d = a(44);b(b.S + b.F, "Object", { make: function make(a, b) {
        return c(d(a), b);
      } });
  }, function (c, d, b) {
    b(135)(Number, "Number", function (a) {
      ...
      var b = this._i++,
          c = !(this._l > b);return { done: c, value: c ? a : b };
    });
  }, function (d, e, a) {
    var b = a(6),
        c = a(303)(/[\\^$*+?.()|[\]{}]/g, "\\$&");b(b.S, "RegExp", { escape: function escape(a) {
        return c(a);
      } });
  }, function (a, b) {
    ...
    var a = b(6),
        c = b(303)(/[&<>"']/g, { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&apos;" });a(a.P + a.F, "String", { escapeHTML: function escapeHTML() {
        return c(this);
      } });
  }, function (d, e, b) {
    var a = b(6),
        c = b(303)(/&(?:amp|lt|gt|quot|apos);/g, { "&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&apos;": "'" });a(a.P + a.F, "String", { unescapeHTML: function unescapeHTML() {
        return c(this);
      } });
