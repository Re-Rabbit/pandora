...
!function (a, b) {
  ...
  var c = [],
    ...
    var a = d.createElement("input"),
      ...
      Ya = r.expr.attrHandle;r.fn.extend({ attr: function attr(a, b) {
    ...
    } }), Xa = { set: function set(a, b, c) {
      return b === !1 ? r.removeAttr(a, c) : a.setAttribute(c, c), c;
    } }, r.each(r.expr.match.bool.source.match(/\w+/g), function (a, b) {
    var c = Ya[b] || r.find.attr;Ya[b] = function (a, b, d) {
      var e,
          f,
          g = b.toLowerCase();return d || (f = Ya[g], Ya[g] = e, e = null != c(a, b, d) ? g : null, Ya[g] = f), e;
    };
  });var Za = /^(?:input|select|textarea|button)$/i,
      $a = /^(?:a|area)$/i;r.fn.extend({ prop: function prop(a, b) {
      ...
      var d,
          ...
          var b = r.find.attr(a, "tabindex");return b ? parseInt(b, 10) : Za.test(a.nodeName) || $a.test(a.nodeName) && a.href ? 0 : -1;
    ...
    return a.getAttribute && a.getAttribute("class") || "";
      ...
      var b,
        ...
        if (arguments.length) return d = r.isFunction(a), this.each(function (c) {
          ...
          var b = r.find.attr(a, "value");return null != b ? b : r.trim(r.text(a)).replace(cb, " ");
    ...
    var c,
      ...
      return this.map(function () {
        ...
        var a = this.type;return this.name && !r(this).is(":disabled") && hb.test(this.nodeName) && !gb.test(a) && (this.checked || !ha.test(a));
      }).map(function (a, b) {
