...
// this pages need every loader resolved
...
function webpackConfig() {
	...
	resolve: {
            root: paths.concat('./').map(n => path.resolve(n))
	},
	plugins: [
	    new webpack1.optimize.CommonsChunkPlugin('commons.js')
	]
    }
}
...
function switchWorkspaceMiddleware(req, res, next) {
	...
	setWorkSpace(matched[1])(bs.reload)
